...
The storefront uses its custom product-search modal backed by Store API product data. The previous Meilisearch/InstantSearch integration was removed during the Medusa 2.18 upgrade because it was unused and pinned an incompatible MikroORM version.
