...
export default function ClickButton({title, href, img = "/assets/links/home_img.png", alt = 'bg__image', icon1, icon2, Kind, onClickAction, onTagAction, className}: NavButton) {
  ...
  return (
    <>
    { Kind === "Submit" ? (
        <button className={`${styles.ClickButton} ${className}`} >
            <motion.div 
