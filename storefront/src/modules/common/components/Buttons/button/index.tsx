...
export default function Button({title, href, img = "/assets/links/home_img.png", alt = 'bg__image', icon1, icon2, Kind, onClickAction, onTagAction, className}: NavButton) {
    ...
    if(icon1) {
       return( 
            <LocalizedClientLink className={styles.buttonIcon} href={href}>
                <motion.div 
                ...
                >
                    ...
                    <motion.div className={styles.el} style={{ perspective: 800 }}>
                        <PerspectiveIcon icon1={icon1} icon2={icon2} alt={alt} active={isActive} backControls={backIconControls} />
                    </motion.div>
                    <motion.div className={styles.el} style={{ perspective: 800 }}>
                        <PerspectiveIcon icon1={icon1} icon2={icon2} alt={alt} active={isActive} backControls={backIconControls} />
                    </motion.div>
